...
# -*- coding: utf-8 -*-
"""
Created on Wed May 22 13:40:08 2019
...
from rllab import spaces # change from gym import spaces TO from rllab import spaces
...
class LunarLander(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        if self.game_over or abs(state[0]) >= 1:
            done   = True
            #reward = 0
            #reward = -100
    ...
    def log_diagnostics(self, paths):
        ...
        logger.record_tabular('AverageHorizonCoord', np.mean(progs))
